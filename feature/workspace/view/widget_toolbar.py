...
class ToolBar(QToolBar):
    ...
    def _init_ui(self):
        ...
        self._a_open_project.setObjectName("open-ProjectEntity")
        self._a_open_project.setEnabled(True)
        self.addAction(self._a_open_project)

        self._a_setting = QAction(get_icon("settings"), "設定", self)
        self._a_setting.setObjectName("edit-setting")
        self._a_setting.setEnabled(False)
        self.addAction(self._a_setting)
    ...
    def update_button_state(self, is_task_alive: bool):
        if is_task_alive:
            ...
            self._a_setting.setEnabled(True)
