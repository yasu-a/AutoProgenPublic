...
from app.di.usecase import get_student_list_id_usecase, \
...
class ScoringStudentControlWidget(QWidget):
...
class ScoringDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        if "middle":
            ...
            if "middle-left":
                ...
                self._w_student_control = ScoringStudentControlWidget(self)
            ...
            if "middle-right":
                ...
                # 上に表示するテストケースの名前とボタン
                self._w_testcase_control = ScoringTestCaseControlWidget(self)
        ...
        if "bottom":
            ...
            self._w_mark_score = ScoringScoreEditWidget(self)
    ...
    def __put_student_mark(
            cls,
            student_mark: StudentMarkEntity,
    ) -> None:
        # ユースケースの使用
    ...
    def __reflect_state(self):
        ...
        # self._w_mark_score: ScoringScoreEditWidget
        if self._state.student_id is None:
