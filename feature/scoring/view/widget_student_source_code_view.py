...
from feature.scoring.view.widget_source_code_text_edit import SourceCodeTextEdit
...
class StudentSourceCodeView(SourceCodeTextEdit):
    ...
    def __init_ui(self):
        ...
        self.set_show_editing_symbols(
            get_setting_get_usecase().execute().show_editing_symbols_in_source_code,
        )
        self.set_line_wrap(
            get_setting_get_usecase().execute().enable_line_wrap_in_source_code,
        )
        self.setPlainText("")
