...
from feature.export.domain.value import ScoreExportFormat, ExcelColumnMapping, ExcelRowRange
...
class SimpleScoreExportRowDto:
    """単純エクスポート（JSON/CSV）用の1行分のデータ構造DTO"""
