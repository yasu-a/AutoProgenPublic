...
from shared.domain.error import StorageRunCompilerServiceError, StorageRunExecutableServiceError
...
def test_execute_normal_scanf_source_code():
    ...
    with create_storage() as storage_id:
        ...
        StorageEntity = storage_repo.get(storage_id)
        StorageEntity.files[FileID.STDIN.deployment_relative_path] = b"12345\n45678\n"
        storage_repo.put(StorageEntity)
...
#         # storage_repo = get_storage_repository()
#         # StorageEntity = storage_repo.get(storage_id)
#         # StorageEntity.files[FileID.STDIN.deployment_relative_path] = b""  # give nothing
#         # storage_repo.put(StorageEntity)
#
#         # コンパイルの実効と標準出力ファイルの書き込み
#         try:
