...
1. ツールバーの「<img src="./img/folder.png" width="15px">設定」をクリックして設定画面を開きます。
...
1. テストケースの編集画面を開きます。
2. 「実行の構成」タブを選択します。
3. 「入力ストリームの構成」の右端にある「<img src="./img/plus.png" width="15px">」アイコンをクリックします。
...
> 採点画面の右下にある「<img src="./img/keyboard.png" width="15px">ショートカット一覧」をクリックした下さい。
...
> [!NOTE]
> 設定画面の「成績記録用Excelのバックアップ」が有効になっていると、点数がエクスポートされる前に、Excelファイルのコピーが作成されます。
