...
def main():
    ...
    test_target_id = TargetID("8")  # 画像では「第8回」が選択されているので8に設定
    
    # CurrentProjectSummaryGetUseCaseをmockしてtarget_idを返すようにする
    from feature.projman.usecase.dto import NormalProjectSummary
    ...
    with patch('app.di.repository.get_student_repository', return_value=student_repo), \
         ...
         patch('app.di.usecase.get_current_project_summary_get_usecase', return_value=mock_current_project_summary_get_usecase):
