...
2. 「実行の構成」タブを選択します。
3. 「入力ストリームの構成」の右上端にある「${icon_plus}」アイコンをクリックします。
4. メニューから「${icon_article}ファイル」を選択して入力ファイルを追加します。
...
1. テストケースの編集画面を開きます。
2. 「自動テストの構成」タブを選択します。
3. 「出力ストリームの自動テスト構成」の右上端にある「${icon_plus}」アイコンをクリックします。
4. メニューから「${icon_console}標準出力」を選択して出力タブを追加します。
...
2. 「自動テストの構成」タブを選択します。
3. 「出力ストリームの自動テスト構成」の右上端にある「${icon_plus}」アイコンをクリックします。
4. メニューから「${icon_article}ファイル」を選択して出力ファイルを追加します。
