...
from shared.domain.value.stage import AbstractStage, ExecuteStage
...
from shared.infra.repository.student_stage_path_result import _AbstractStageResultHelper
