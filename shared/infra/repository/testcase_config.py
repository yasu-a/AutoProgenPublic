...
class TestCaseConfigRepository(ITestCaseConfigRepository):
    def __init__(
        ...
        self._lock = QMutex()
        self._testcase_cache: dict[TestCaseID, TestCaseConfigEntity] = {}
    ...
    def put(self, testcase_config: TestCaseConfigEntity):
        with self.__lock():
    ...
    def get(self, testcase_id: TestCaseID) -> TestCaseConfigEntity:
        with self.__lock():
            if testcase_id not in self._testcase_cache:
                ...
                self._testcase_cache[testcase_id] = TestCaseConfigEntity(
                    testcase_id=testcase_id,
