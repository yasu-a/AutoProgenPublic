...
class ProjectCoreIO:
    ...
    def copy_file_into_folder(
        ...
        self._logger.debug(
            f"copy_file_into_folder({project_id=}, {src_file_fullpath=}, {dst_folder_fullpath=})")
    ...
    def copy_files_in_folder_into_folder(
        ...
        self._logger.debug(
            f"copy_files_in_folder_into_folder({project_id=}, {src_folder_fullpath=}, {dst_folder_fullpath=})")
    ...
    def copy_external_file_into_folder(
        ...
        self._logger.debug(
            f"copy_external_file_into_folder({project_id=}, {src_file_fullpath=}, {dst_folder_fullpath=})")
        if dst_file_name is None:
            dst_file_name = src_file_fullpath.name
        shutil.copy(src_file_fullpath, dst_folder_fullpath / dst_file_name)
